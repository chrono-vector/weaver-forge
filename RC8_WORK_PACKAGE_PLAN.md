...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `WP-RC8-001` | Establish RC8 Management Baseline | Create the eight root-level non-authoritative management baseline documents with required sections, tables, vocabularies, gates, and cross-references | `ISSUE-RC8-001`, `ISSUE-RC8-010` | `ISSUE-RC8-002`, `ISSUE-RC8-003`, `ISSUE-RC8-004`, `ISSUE-RC8-005`, `ISSUE-RC8-006`, `ISSUE-RC8-007`, `ISSUE-RC8-008`, `ISSUE-RC8-009`, `ISSUE-RC8-011` | `RC8 Management` | `Compatible` | None intended; index and reference only | Freeze direction accepted; eight-artifact set accepted in principle (`GOV-001`); no protected-file edits planned | Eight files exist at repository root; shared notices present; required tables/columns present; no existing file modified | Matches Blueprint document specs; no READY/NOT READY claim; no C-014 completion; no finding/blocker CLEAR/CLOSED; no IW/RC9 authorization | Created files; working-tree changed-file list; protected-file unchanged check; cross-document ID consistency | Cursor or Grok implementation agent | Pi read-only reviewer; repository maintainer for authorization | `GATE-01`, `GATE-03`, `GATE-04`, `GATE-05`, `GATE-06`, `GATE-07`, `GATE-08` | `In Progress` | Not currently identified | `Not Evaluated` | Not pushed | Implementation pass creates files only; no stage/commit/push in the creation instruction |
