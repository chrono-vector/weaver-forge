...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `FC-001` | Formal Source Weaver evaluation for RC8 | `ISSUE-RC8-004` | RC8 has no formal Source Weaver READY/NOT READY decision; creating such a decision is outside management-baseline freeze work | Source evaluation / lifecycle decision | Would require formal Source process beyond management docs | `GATE-12`; current lifecycle sources | Formal Source evaluation by designated authority | Explicit designation of formal decision authority and evaluation scope | Not currently identified beyond existing package and audit surfaces | Does not by itself authorize Independent Witness | `Awaiting Formal Source Evaluation` | Separate formal Source authorization, scoped evaluation plan, and explicit decision record | Backlog placement does not authorize implementation, RC9, future-candidate creation, release, or Independent Witness handoff. | Per `STATUS.md`, no formal Source Weaver READY/NOT READY exists for RC8 |
