...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `TRACE-RC8-001` | `ISSUE-RC8-001` | Establish RC8 management baseline artifacts | Repository observation / management baseline acceptance | Accepted eight-artifact set; prior absence of root management files | `RC8 Management` | `Compatible` | `WP-RC8-001` | N/A | `GOV-001` | `CONTRACT-IDX-036`–`043` | `GATE-05` | `Not Evaluated` | Not currently identified | `EVID-001` (charter/freeze/index creation in working tree); `REVIEW-PI-001` Not currently identified | `Not Evaluated` | Not pushed | Not applicable | Management implementation in progress via `WP-RC8-001` | Creates management docs only |
...
| `TRACE-RC8-010` | `ISSUE-RC8-010` | Management gate and traceability model required | Management baseline acceptance / charter | `PROJECT_CHARTER.md` §11; freeze §13 | `RC8 Management` | `Compatible` | `WP-RC8-001` | N/A | `GOV-001` | `CONTRACT-IDX-036`, `CONTRACT-IDX-037`, `CONTRACT-IDX-042` | `GATE-07` | `Not Evaluated` | Not currently identified | `EVID-010` = baseline docs containing gate/trace model | `Not Evaluated` | Not pushed | Not applicable | Management implementation in progress via `WP-RC8-001` | Not a formal audit |
...
|---|---|---|
| `EVID-001` | Management baseline file-creation working tree | Root-level eight management files |
