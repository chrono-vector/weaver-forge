...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `ISSUE-RC8-001` | Establish RC8 management baseline artifacts | Eight accepted root-level management artifacts were absent and are being created as non-authoritative management docs | Repository observation / management baseline acceptance | Blueprint accepted artifact set; prior absence check | `RC8 Management` | `In Progress` | `RC8 Work Package` | `Compatible` | No | `WP-RC8-001` | N/A | `GATE-01`, `GATE-04`, `GATE-05` | Repository maintainer | Pi read-only reviewer | Charter, freeze boundary, contract index | Create eight root-level management files only | Not applicable — documentation creation, not technical finding closure | Does not alter protected files |
...
| `ISSUE-RC8-010` | Management gate and traceability model required | RC8 needs explicit gates and traceability to avoid piecemeal implementation and authority confusion | Management baseline acceptance / `PROJECT_CHARTER.md` | Charter §11; freeze boundary §13 | `RC8 Management` | `In Progress` | `RC8 Work Package` | `Compatible` | No | `WP-RC8-001` | N/A | `GATE-07` | Repository maintainer | Pi read-only reviewer | Issue register + matrix | Embed gate and traceability model in baseline docs | Not applicable — management process only | Does not equal formal audit |
