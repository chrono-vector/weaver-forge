# Witness classification — precedence (Future Candidate 4 active; FC-01/FC-02 and RC6-RC8 historical)
Active candidate examples use **Weaver Forge Future Candidate 4** with mapping **WF-FC-04 -> weaver-forge-fc-04** (Repository Owner). Historical Future Candidates **WF-FC-01** / **WF-FC-02** / **WF-FC-03** and historical RC6/RC7/RC8 examples remain labeled historical.

Applies to active Future Candidate identity **WF-FC-04** / **`weaver-forge-fc-04`** (governance-selected; identity authority: Repository Owner; RC9 **NOT IMPLIED**). Historical Future Candidate tags **`weaver-forge-fc-01`**, **`weaver-forge-fc-02`**, and **`weaver-forge-fc-03`** remain immutable historical NOT READY only. Historical last immutable package version **1.0.0-rc6** (canonical package tag
...
history at those tags; this file states **current** policy only. rc1–rc7 were each ruled/audited or fixed as historical; RC8 is historical static-audit only. Active examples use **WF-FC-04** / **weaver-forge-fc-04**. rc1–rc6 were each ruled/audited
**NOT READY**. Active Host/templates host Future Candidate 4 identity. No Independent Witness authorization is implied. Independent
...
| 4 | **Canonical package-tag mismatch** — the Weaver Forge tag actually resolved and used is not the expected tag for the declared `package_version` (active `WF-FC-04` requires `weaver-forge-fc-04`; historical `WF-FC-01` requires `weaver-forge-fc-01`; historical `WF-FC-02` requires `weaver-forge-fc-02`; historical `WF-FC-03` requires `weaver-forge-fc-03`; historical `1.0.0-rc8` requires `grok-build-witness-v1.0.0-rc8`; historical `1.0.0-rc5` requires `grok-build-witness-v1.0.0-rc5`; historical `1.0.0-rc4` requires `grok-build-witness-v1.0.0-rc4`), or the tag could not be resolved on `origin` at all | **FAIL** |
