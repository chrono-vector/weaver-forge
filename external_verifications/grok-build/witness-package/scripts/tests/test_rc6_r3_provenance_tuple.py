...
class Rc6R3SchemaAuthorityTests(unittest.TestCase):
    ...
    def test_01_active_default_is_rc6_2(self) -> None:
        ...
        self.assertEqual(hist.get("active_authority"), "rc6.5")
        self.assertEqual(hist.get("immediate_predecessor_version"), "rc6.4")
        self.assertEqual(
            set(hist.get("historical_register_versions") or []),
            {"rc6.4", "rc6.3", "rc6.2", "rc6.1", "rc5-phase4-s2.1", "rc5-phase4-s1.1"},
        )
    ...
    def test_03_one_active_register_file(self) -> None:
        ...
        self.assertIn('"schema_register_version": "rc6.5"', active)
...
class Rc6R3ProvenanceBindingTests(unittest.TestCase):
    ...
    def test_13_default_validation_never_selects_rc61_by_shape(self) -> None:
        # Omitting R3 markers must fail under active rc6.5 — not silently use rc6.1.
        ...
        reject_active = v.validate_dir(tree, schema_register_version="rc6.5")
