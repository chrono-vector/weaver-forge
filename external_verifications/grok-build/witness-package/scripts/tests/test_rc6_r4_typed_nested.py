...
class Rc6R4SchemaAuthorityTests(unittest.TestCase):
    ...
    def test_01_active_default_is_rc6_3(self) -> None:
    ...
    def test_02_historical_rc62_explicit_only(self) -> None:
        ...
        reject = v.validate_dir(FIXTURES / "rc6-r4-synthetic-final", schema_register_version="rc6.3")
        self.assertTrue(any("active authority" in e for e in reject), reject)

    def test_03_active_and_historical_fixtures(self) -> None:
        self.assertEqual(v.validate_dir(FIXTURES / "rc6-r4-synthetic-final"), [])
        self.assertEqual(
            v.validate_dir(FIXTURES / "rc6-r4-synthetic-preliminary", host_preliminary=True),
            [],
        )
...
class Rc6R4NestedClassTests(unittest.TestCase):
    ...
    def test_04_arbitrary_listed_hashed_nested_rejected(self) -> None:
        tree = _copy_fixture("rc6-r4-synthetic-final")
        nested = tree / "nested"
        nested.mkdir()
    ...
    def test_05_unknown_prefix_and_path_class_mismatch(self) -> None:
        ...
        tree2 = _copy_fixture("rc6-r4-synthetic-final")
        run_id = next(
            line.split("=", 1)[1]
