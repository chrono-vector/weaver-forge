#!/usr/bin/env python3
"""RC6-R1 focused tests: active rc6.1 schema register and exact-key enforcement.
...
class Rc6R1RegisterAuthorityTests(unittest.TestCase):
    ...
    def test_01_active_default_is_rc6_1(self) -> None:
    ...
    def test_02_historical_s2_s1_explicit_only(self) -> None:
    ...
    def test_03_supersession_and_non_competing_historical(self) -> None:
        ...
        self.assertEqual(hist.get("active_authority"), "rc6.1")
        self.assertEqual(hist.get("immediate_predecessor_version"), "rc5-phase4-s2.1")
        self.assertEqual(hist.get("earlier_historical_compatibility_version"), "rc5-phase4-s1.1")
    ...
    def test_10_historical_rc4_and_rc5_fixtures_still_pass(self) -> None:
        ...
        self.assertEqual(v.validate_dir(rc5p, host_preliminary=True), [])
        rc5f = FIXTURES / "rc5-synthetic-final-success"
        self.assertEqual(v.validate_dir(rc5f), [])
    ...
    def test_11_rc6_synthetic_fixtures_conform(self) -> None:
    ...
    def test_12_witness_statement_ai_assistance_detail_authorized(self) -> None:
        ...
        self.assertEqual(v.validate_dir(tree_ok), [])
        ...
        errors_missing = v.validate_dir(tree_missing)
        self.assertTrue(
        ...
        errors_unknown = v.validate_dir(tree_unknown)
        self.assertTrue(
