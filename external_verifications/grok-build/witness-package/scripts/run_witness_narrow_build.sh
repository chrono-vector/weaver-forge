...
#
# Package version WF-FC-01 (Weaver Forge Future Candidate 1; host-orchestrator).
# Identity authority: Repository Owner accepted G-3 decision. Mapping: WF-FC-01 -> weaver-forge-fc-01.
...
# ---------------------------------------------------------------------------
readonly PACKAGE_VERSION="WF-FC-01"
readonly CANONICAL_WEAVER_FORGE_URL="https://github.com/chrono-vector/weaver-forge.git"
readonly CANONICAL_WEAVER_FORGE_TAG="weaver-forge-fc-01"
