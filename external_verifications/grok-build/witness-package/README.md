...
| Field | Value |
|-------|-------|
| Governance-selected Future Candidate | **Weaver Forge Future Candidate 3** / **WF-FC-03** / **`weaver-forge-fc-03`** |
| Future Candidate implementation state | **active package-native identity aligned to WF-FC-03; annotated tag for this candidate may be created in a later gate** |
...
| Active surfaces | Future Candidate 3 identity on Host/templates/validator mapping; not RC9; not READY; not release-approved; not authorized for Independent Witness handoff |
...
| Active Future Candidate tag (expected for `WF-FC-03`) | `weaver-forge-fc-03` |
| Historical Future Candidate tags | `weaver-forge-fc-01`, `weaver-forge-fc-02` (immutable historical NOT READY) |
...
Do **not** start from an unpinned `main` tip alone. For Future Candidate 3, resolve the **annotated package tag** `weaver-forge-fc-03` when that tag exists for the declared candidate identity. Independent Witness handoff is not authorized. Historical immutable packages continue to use their historical tags (e.g. `weaver-forge-fc-01`, `weaver-forge-fc-02`, `grok-build-witness-v1.0.0-rc6`). Canonical execution requires successful annotated-tag resolution; if resolution fails, canonical execution stops. Floating `main` is not a substitute package identity and is not authorized for Independent Witness handoff.
...
1. [WITNESS_PACKAGE_VERSION.md](WITNESS_PACKAGE_VERSION.md) — Future Candidate 3 identity anchor
...
- **NOT READY** — Future Candidate 3 is governance-selected for active package-native identity. This is not package-readiness PASS.
...
- Active surfaces carry Future Candidate 3 identity (**WF-FC-03** / **`weaver-forge-fc-03`**). Historical Future Candidates **WF-FC-01** / **WF-FC-02** remain immutable history only; **not** RC9; not READY; not release-approved; not authorized for Independent Witness handoff. No release, production readiness, Independent Witness PASS, or C-014 completion is claimed.
