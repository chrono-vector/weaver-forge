...
| Field | Value |
|-------|-------|
| Governance-selected Future Candidate | **Weaver Forge Future Candidate 4** / **WF-FC-04** / **`weaver-forge-fc-04`** |
| Future Candidate implementation state | **active package-native identity aligned to WF-FC-04; annotated tag for this candidate may be created in a later gate** |
...
| **Current package status** | **FUTURE CANDIDATE 4 GOVERNANCE-SELECTED (Weaver Forge Future Candidate 4 / WF-FC-04 / weaver-forge-fc-04) — ACTIVE PACKAGE-NATIVE IDENTITY ALIGNED — NOT READY — INDEPENDENT WITNESS HANDOFF NOT AUTHORIZED — C-014 NOT_STARTED — NO FINDING/BLOCKER CLEAR/CLOSED — RC8/RC7/RC6/FC-01/FC-02 IMMUTABLE HISTORICAL ONLY — NO RELEASE, PRODUCTION READINESS, INDEPENDENT WITNESS PASS, RC9, OR C-014 COMPLETION** |
...
| Active surfaces | Future Candidate 4 identity on Host/templates/validator mapping; not RC9; not READY; not release-approved; not authorized for Independent Witness handoff |
...
| Active Future Candidate tag (expected for `WF-FC-04`) | `weaver-forge-fc-04` |
| Historical Future Candidate tags | `weaver-forge-fc-01`, `weaver-forge-fc-02`, `weaver-forge-fc-03` (immutable historical NOT READY) |
...
Do **not** start from an unpinned `main` tip alone. For Future Candidate 4, resolve the **annotated package tag** `weaver-forge-fc-04` when that tag exists for the declared candidate identity. Independent Witness handoff is not authorized. Historical immutable packages continue to use their historical tags (e.g. `weaver-forge-fc-01`, `weaver-forge-fc-02`, `weaver-forge-fc-03`, `grok-build-witness-v1.0.0-rc6`). Canonical execution requires successful annotated-tag resolution; if resolution fails, canonical execution stops. Floating `main` is not a substitute package identity and is not authorized for Independent Witness handoff.
...
1. [WITNESS_PACKAGE_VERSION.md](WITNESS_PACKAGE_VERSION.md) — Future Candidate 4 identity anchor
...
- **NOT READY** — Future Candidate 4 is governance-selected for active package-native identity. This is not package-readiness PASS.
...
- Active surfaces carry Future Candidate 4 identity (**WF-FC-04** / **`weaver-forge-fc-04`**). Historical Future Candidates **WF-FC-01** / **WF-FC-02** / **WF-FC-03** remain immutable history only; **not** RC9; not READY; not release-approved; not authorized for Independent Witness handoff. No release, production readiness, Independent Witness PASS, or C-014 completion is claimed.
