...
| Field | Value |
|-------|-------|
| Governance-selected Future Candidate name | **Weaver Forge Future Candidate 4** |
| Governance-selected candidate version | **WF-FC-04** |
| Governance-selected candidate tag | **`weaver-forge-fc-04`** |
| Normative mapping (active) | **WF-FC-04 -> weaver-forge-fc-04** |
| Historical Future Candidate mappings | **WF-FC-01 -> weaver-forge-fc-01**; **WF-FC-02 -> weaver-forge-fc-02**; **WF-FC-03 -> weaver-forge-fc-03** (immutable historical NOT READY) |
| Identity and technical-contract authority | **Repository Owner** |
| Relationship to RC8 | **Future Candidate line successor only (historical RC8 not active)** |
| Relationship to RC9 | **NOT IMPLIED** |
| Implementation object state | **active package-native identity aligned to WF-FC-04** |
...
| Historical Future Candidate 1 | **WF-FC-01** / **`weaver-forge-fc-01`** (immutable historical NOT READY) |
| Historical Future Candidate 2 | **WF-FC-02** / **`weaver-forge-fc-02`** (immutable historical NOT READY) |
| Active schema | **rc6.5** |
| Independent Witness reproduction | **NOT PERFORMED** |
| Independent Witness PASS | **NONE** |
| Independent Witness (C-014) | **NOT_STARTED** |
| Overall | **PARTIAL** / **NOT READY** — Future Candidate 4 is governance-selected for active package-native identity |
| Grok Build source commit (upstream pin) | `98c3b2438aa922fbbe6178a5c0a4c48f85edc8ce` |

## Current status banner

**FUTURE CANDIDATE 4 GOVERNANCE-SELECTED — Weaver Forge Future Candidate 4 / WF-FC-04 / `weaver-forge-fc-04` — NORMATIVE MAPPING WF-FC-04 -> weaver-forge-fc-04 — IDENTITY AUTHORITY: REPOSITORY OWNER — RC9 NOT IMPLIED — ACTIVE PACKAGE-NATIVE IDENTITY ALIGNED — NOT READY — INDEPENDENT WITNESS HANDOFF NOT AUTHORIZED — C-014 NOT_STARTED — NO FINDING CLEAR/CLOSED — NO INDEPENDENT WITNESS REPRODUCTION — NO INDEPENDENT WITNESS PASS — WF-FC-01 / WF-FC-02 IMMUTABLE HISTORICAL ONLY**

- Active candidate-native identity for Host constants and load-bearing templates is **WF-FC-04** / **`weaver-forge-fc-04`**.
- Historical Future Candidate identities **WF-FC-01** / **`weaver-forge-fc-01`**, **WF-FC-02** / **`weaver-forge-fc-02`**, and **WF-FC-03** / **`weaver-forge-fc-03`** remain immutable historical NOT READY only (not active package defaults).
- Do **not** describe Future Candidate 4 as READY, release-approved, Independent Witness PASS, RC9, or Source Weaver-approved.
...
| Field | Value |
|-------|-------|
| Tag | `grok-build-witness-v1.0.0-rc5` |
| Tag object ID (annotated tag object) | `9c01e314249f59945e93597af6ece2e3fb33e6cd` |
| Peeled commit | `5ae08cb8be9c1c97f25b9093bb5490a0ef195a07` |
| Tree | `97ad93d80480b23a49f1636ff55dae449202aa3c` |
| Archive path | `C:\dev\weaver-forge-audit-exports\weaver-forge-grok-build-witness-v1.0.0-rc5.zip` |
| Archive SHA-256 | `5bf6e8f66795ba310ad5b149b721ca1930b5729ab3c568a20559d8dda40e0435` |
| Transfer-bundle path | `C:\dev\weaver-forge-audit-exports\weaver-forge-grok-build-witness-v1.0.0-rc5-transfer-bundle.zip` |
| Transfer-bundle SHA-256 | `5581b10788f0a3ee7a36982ac1b2468c658afc353fe88da3423298b60344bb2b` |

RC5 remains **immutable**. Do not move, delete, recreate, replace, overwrite, retag, regenerate, or relabel the RC5 tag, archive, or transfer bundle.

### Required RC5 status

- RC5 is **NOT READY**.
- Independent Witness handoff for RC5 is **not authorized**.
- Independent Witness reproduction of RC5 has **not** occurred.
- Independent Witness PASS for RC5 does **not** exist.
- C-014 remains **`NOT_STARTED`**.
- Do not state or imply RC5 READY, RC5 released as an approved result, RC5 Independent Witness PASS, RC5 handoff approved, C-014 started or completed, or RC5 findings cleared/closed.

## Immutable releases

| Version | Tag | Peeled commit | Release state | Static audit status | Static disposition | Independent Witness reproduction | C-014 |
|---------|-----|---------------|---------------|---------------------|--------------------|----------------------------------|-------|
...
## Historical next-candidate RC7 wording (superseded as active identity; historical only)
...
The **annotated package tag** is the canonical package entry identity for a fixed release.

Canonical execution against an immutable tagged package:

1. Uses the exact annotated package tag for the declared `package_version`
2. Fresh-clones Weaver Forge and fetches tags from `origin`
3. Resolves `refs/tags/<tag>^{commit}` to one full 40-character peeled commit
4. Checks out that commit **detached**
5. Requires checked-out `HEAD` to equal the resolved peeled commit
6. Requires the package clone to be clean
7. Records requested tag, annotated tag object ID where required, resolved peeled commit, HEAD, detached state, and clean state in Witness evidence
8. Uses that resolved full peeled commit as the **run-specific** immutable Weaver Forge package identity

**Tag availability** is verified only through Git resolution of the annotated tag. Canonical execution requires that resolution to succeed. If resolution fails, canonical execution must stop with truthful failure evidence. After publication, the tag is immutable and its resolved full peeled commit is the package identity for that run.
...
Do **not** use floating `main` as package identity. Active Host/templates carry governance-selected Future Candidate 4 identity (**WF-FC-04** / **`weaver-forge-fc-04`**). Independent Witness handoff is **not** authorized.

### Historical package-version compatibility

Historical evidence declaring `package_version=1.0.0-rc4` continues to require tag `grok-build-witness-v1.0.0-rc4`. Evidence declaring `package_version=1.0.0-rc5` requires tag `grok-build-witness-v1.0.0-rc5`. Evidence declaring `package_version=1.0.0-rc6` requires tag `grok-build-witness-v1.0.0-rc6`. Evidence declaring `package_version=WF-FC-01` requires tag `weaver-forge-fc-01` (historical). Evidence declaring `package_version=WF-FC-02` requires tag `weaver-forge-fc-02` (historical). Evidence declaring `package_version=WF-FC-03` requires tag `weaver-forge-fc-03` (historical). Evidence declaring `package_version=WF-FC-04` requires tag `weaver-forge-fc-04` (active). Evidence declaring `package_version=1.0.0-rc8` requires tag `grok-build-witness-v1.0.0-rc8` (historical). Evidence declaring `package_version=1.0.0-rc7` requires tag `grok-build-witness-v1.0.0-rc7` (historical). Tag mismatch itself must never be used to infer historical compatibility. Unknown or unsupported `package_version` values fail closed.
...
- Active Future Candidate package tag (expected for `WF-FC-04`): **`weaver-forge-fc-04`**.
- Historical Future Candidate tags: **`weaver-forge-fc-01`**, **`weaver-forge-fc-02`**, **`weaver-forge-fc-03`** (immutable historical NOT READY; not active defaults).
...
- Historical RC7/RC8 and historical Future Candidate tags remain immutable history only.
...
| Field | Required |
|-------|----------|
| Package tag requested | exact annotated tag for the declared `package_version` (e.g. `weaver-forge-fc-04` for active `WF-FC-04`; historical `WF-FC-01` requires `weaver-forge-fc-01`; historical `WF-FC-02` requires `weaver-forge-fc-02`; historical `WF-FC-03` requires `weaver-forge-fc-03`; historical `1.0.0-rc8` requires `grok-build-witness-v1.0.0-rc8`; historical `1.0.0-rc7` requires `grok-build-witness-v1.0.0-rc7`; historical `1.0.0-rc6` requires `grok-build-witness-v1.0.0-rc6`; historical `1.0.0-rc5` requires `grok-build-witness-v1.0.0-rc5`; historical `1.0.0-rc4` requires `grok-build-witness-v1.0.0-rc4`) |
...
Host helper `run_witness_narrow_build.sh` fails clearly if the requested tag cannot be resolved, if detached HEAD does not match the resolved peeled tag commit, or if the package clone is dirty.
