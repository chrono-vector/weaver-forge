...
> **Witness note (current):** Owner-side log only. Witness package status is **NOT READY** — package version `1.0.0-rc4`; fixed immutable annotated tag `grok-build-witness-v1.0.0-rc4` → commit `039b46737c5968a81fb756d7a6d1d0dd57b6ad96`; rc4 static blind audit **COMPLETE** with final disposition **NOT READY** (40 integrated blockers). `grok-build-witness-v1.0.0-rc1`, `rc2`, `rc3`, and `rc4` are immutable releases, each with a recorded **NOT READY** audit. Phase 0 audit intake is complete. Phase 1 documentation and release/status remediation is being performed on `main`. Technical implementation remediation of scripts, schemas, validators, tests, and execution controls has not begun. `main` is being prepared toward a possible future rc5 candidate; **no rc5 tag exists**. Canonical Witness procedure: **`witness-package/WITNESS_RUNBOOK.md`** and **`scripts/run_witness_narrow_build.sh`** (canonical execution requires successful tag resolution). No Witness execution has occurred. Independent Witness reproduction **NOT PERFORMED**. Independent Witness PASS **NONE**. C-014 **NOT_STARTED**.
>
> **Historical note (C2E-5 contemporaneous wording):** Earlier text said “rc4 package content under preparation.” That prospective wording is superseded by the current note above.
